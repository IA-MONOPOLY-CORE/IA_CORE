...
def extraer_herramientas_de_respuesta(respuesta: str, score: float, agente_id: str, rol: str) -> List[dict]:
    """
...
def aplicar_lecciones_pendientes(agente_id: str, contexto_actual: str) -> Optional[str]:
    ...
    try:
        ...
        memoria = cargar_memoria(agente_id)
        lecciones_no_aplicadas = [l for l in memoria.get("lecciones_absorbidas", []) if not l.get("aplicada", False)]
