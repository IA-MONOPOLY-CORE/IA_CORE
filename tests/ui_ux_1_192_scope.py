...
"""
S5_CSS = """
/* UI/UX 1.194 S5: improve legibility and focus visibility without changing state semantics. */
body .final-screen-contracts-rehousing .visual-state,
body #request-draft-panel .visual-state,
body .console-utilities .admin-status {
    min-width: 0;
    max-width: 100%;
    line-height: 1.35;
    overflow-wrap: anywhere;
...
body #request-draft-panel #request-draft-blocked-control.request-draft-control:disabled {
    min-height: 36px;
    opacity: 0.86;
    line-height: 1.35;
    overflow-wrap: anywhere;
...
body #functional-widgets .data-widget-title,
body #functional-widgets .data-widget-value {
    line-height: 1.35;
    overflow-wrap: anywhere;
}

body #closure-matrix-ui-ux-1x .closure-matrix-main h3 {
    line-height: 1.3;
}

body #functional-widgets button:focus-visible,
body #closure-matrix-ui-ux-1x button:focus-visible,
body #request-draft-panel .request-draft-toggle:focus-visible,
body .console-utilities button:focus-visible {
