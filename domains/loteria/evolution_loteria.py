"""
domains/loteria/evolution_loteria.py - Implementación específica de gestión evolutiva para Lotería/S.A.A.O.P.
Hereda de EvolutionManagerBase e implementa toda la lógica específica del dominio de lotería.
"""
...
class EvolutionManagerLoteria(EvolutionManagerBase):
    ...
    def _get_acierto_threshold(self) -> int:
        """En lotería, consideramos acierto si hay 4 o más números acertados"""
        return 4

    def _get_ventana_size(self) -> int:
        """Ventana rodante de 50 sorteos"""
        return 50

    def _get_baseline_precision(self) -> float:
        """Baseline de lotería: 22.1% (azar estructural)"""
        return 22.1
    ...
    def registrar_juego(self,
        ...
        ciclo = self._state[self.state_key]["ciclo_actual"]
        historial = self._state[self.state_key]["historial_agentes"]
        ...
        # Actualizar métricas acumuladas específicas de lotería
        if aciertos >= 4:
        ...
        self._check_regeneracion_papers(sorteo)
    ...
    def actualizar_parametros(self, nuevos_parametros: Dict[str, Any]):
        ...
        Maneja parámetros específicos de lotería.
        """
        params = self._state[self.state_key]["parametros_evolutivos"]
    ...
    def _get_current_sorteo(self) -> int:
        ...
        return self._state[self.state_key]["ciclo_actual"]["sorteo_actual"]

    def get_ultimos_juegos(self, n: int = 10) -> List[dict]:
        """Retorna los últimos N juegos registrados"""
        ultimos = self._state[self.state_key]["ciclo_actual"]["ultimos_50_juegos"]
    ...
    def _check_regeneracion_papers(self, sorteo_actual: int):
        """
