...
- Next pending step: `PROMPT UI/UX 1.30 - Checkpoint Density Reduction / Information Architecture IA_CORE contract-aware sin runtime/no-execution`.
...
4. Continue only with the exact next prompt: `PROMPT UI/UX 1.30 - Checkpoint Density Reduction / Information Architecture IA_CORE contract-aware sin runtime/no-execution`.
...
- Plan 1.27, audit 1.28 and hardening 1.29 are local by default; the next recommended restore point is after the Density Reduction / Information Architecture checkpoint 1.30, unless a critical change or explicit operator decision requires earlier push.
