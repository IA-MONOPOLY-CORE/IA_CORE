...
| S8a | canonical evidence finalization | recorded by the gate | same gate event | 0 | evidence SHA is recorded in canonical evidence and rendered report |
| S8b | post-evidence receipt | recorded by the gate | recorded by the gate | machine-generated | receipt SHA is recorded in the post-evidence receipt and rendered report |
