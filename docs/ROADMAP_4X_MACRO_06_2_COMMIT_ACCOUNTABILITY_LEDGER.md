...
| R3C post-basis surface repair | `77ac332968ee0b908fcdc1e880b317e9505180ce` | Allow the exact committed documentary delta while requiring mutable surfaces to be empty | Focused gate tests, focal, historical, Level A and terminal runs passed |
...
| Documentary lock | `DOCUMENTARY_LOCK_SELF_REFERENCE` | Add final evidence, receipts, checkpoint, logs and closure documents | Parent is `77ac332968ee0b908fcdc1e880b317e9505180ce`; postpublish renderer resolves final head |
