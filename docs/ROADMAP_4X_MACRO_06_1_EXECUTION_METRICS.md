...
```text
CANONICAL_EVIDENCE_SHA256: RECORDED_IN_CANONICAL_EVIDENCE_AND_RENDERED_REPORT
POST_EVIDENCE_RECEIPT_SHA256: RECORDED_IN_MACHINE_RECEIPT_AND_RENDERED_REPORT
PRELOCK_RECEIPT_SHA256: RECORDED_IN_MACHINE_RECEIPT_AND_RENDERED_REPORT
CANONICAL_FINALIZED_AT: RECORDED_IN_CANONICAL_EVIDENCE_AND_RENDERED_REPORT
POST_EVIDENCE_COMPLETED_AT: RECORDED_IN_MACHINE_RECEIPT_AND_RENDERED_REPORT
