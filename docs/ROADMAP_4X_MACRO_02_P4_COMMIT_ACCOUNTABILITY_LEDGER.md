...
| 4R3 | `274e16cd5086f57afbe9abc73c1132baa34f0223` | Documentary closeout continuity repair | Historical guards accept the exact four Macro 02 closeout documents | PASS |
...
The immutable Level A basis is `274e16cd5086f57afbe9abc73c1132baa34f0223`:

- `6986 passed, 6 skipped, 5 warnings` in `1541.24 s` for the full suite.
...
The first three full-suite replays exposed only historical guard/allowlist
continuity mismatches caused by legitimate file, line or documentary
displacement. The repairs were exact and local: no assertion was deleted, no
global guard was relaxed, and no product/protected surface was broadened. The
final post-closeout replay is the valid green basis.
