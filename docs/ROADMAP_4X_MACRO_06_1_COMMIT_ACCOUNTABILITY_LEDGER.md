...
| R4 | `21077e0c0de348f6b622d3e94596b5283a8a002f` | `16cf06b9262bdef0b0e2a14baa7b351a33b639ba` | `docs(closure): record macro 06.1 VERO FIRE exercise` | record reports and draft canonical evidence | strict JSON and historical scope | revert documentary draft only |
